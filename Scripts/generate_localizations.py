...
TRANSLATIONS: dict[str, dict[str, str]] = {
    ...
    "Only official messaging and Mail apps installed on your Mac. Quick reply works when the system banner exposes a Reply field.": {
        "pl": "Tylko oficjalne komunikatory i Mail zainstalowane na Macu. Szybka odpowiedź działa, gdy baner systemowy udostępnia pole Odpowiedz.",
        "de": "Nur offizielle Messaging- und Mail-Apps auf dem Mac. Schnellantwort funktioniert, wenn das Systembanner ein Antwortfeld anbietet.",
        "it": "Solo app di messaggistica e Mail ufficiali installate sul Mac. La risposta rapida funziona quando il banner di sistema espone un campo Rispondi.",
        "es": "Solo apps oficiales de mensajería y Mail instaladas en el Mac. La respuesta rápida funciona cuando el banner del sistema muestra un campo Responder.",
    },
    "Mail": {"pl": "Mail", "de": "Mail", "it": "Mail", "es": "Mail"},
    "Reply": {"pl": "Odpowiedz", "de": "Antworten", "it": "Rispondi", "es": "Responder"},
    "Reply…": {"pl": "Odpowiedź…", "de": "Antwort…", "it": "Rispondi…", "es": "Responder…"},
    "Send": {"pl": "Wyślij", "de": "Senden", "it": "Invia", "es": "Enviar"},
    "Open app": {"pl": "Otwórz aplikację", "de": "App öffnen", "it": "Apri app", "es": "Abrir app"},
    ...
    "Manage license": {"pl": "Zarządzaj licencją", "de": "Lizenz verwalten", "it": "Gestisci licenza", "es": "Gestionar licencia"},
    ...
    "Sound is muted — turn up volume to hear the alert.": {
        "pl": "Dźwięk jest wyciszony — podgłośnij, żeby usłyszeć alarm.",
        "de": "Ton ist stumm — Lautstärke erhöhen, um den Alarm zu hören.",
        "it": "L’audio è disattivato — alza il volume per sentire l’avviso.",
        "es": "El sonido está silenciado — sube el volumen para oír la alerta.",
    },
    "Dismiss": {"pl": "Zamknij", "de": "Schließen", "it": "Chiudi", "es": "Cerrar"},
    "Alert sound": {"pl": "Dźwięk alertu", "de": "Warnton", "it": "Suono di avviso", "es": "Sonido de alerta"},
    "None": {"pl": "Brak", "de": "Keiner", "it": "Nessuno", "es": "Ninguno"},
    "Preview": {"pl": "Podgląd", "de": "Vorschau", "it": "Anteprima", "es": "Vista previa"},
    "Ringtones": {"pl": "Dzwonki", "de": "Klingeltöne", "it": "Suonerie", "es": "Tonos"},
    "System sounds": {"pl": "Dźwięki systemowe", "de": "Systemtöne", "it": "Suoni di sistema", "es": "Sonidos del sistema"},
    "Played when the timer finishes.": {
        "pl": "Odtwarzany po zakończeniu minutnika.",
        "de": "Wird abgespielt, wenn der Timer endet.",
        "it": "Riprodotto al termine del timer.",
        "es": "Se reproduce al finalizar el temporizador.",
    },
    "Same tones as the Clock app. Plays until you dismiss the finished timer.": {
        "pl": "Te same dźwięki co w aplikacji Zegar. Gra, aż zamkniesz zakończony minutnik.",
        "de": "Dieselben Töne wie in der Uhr-App. Spielt, bis du den beendeten Timer schließt.",
        "it": "Stessi toni dell’app Orologio. Continua finché non chiudi il timer terminato.",
        "es": "Los mismos tonos que en la app Reloj. Suena hasta que cierres el temporizador finalizado.",
    },
    ...
    "End call": {"pl": "Zakończ połączenie", "de": "Anruf beenden", "it": "Termina chiamata", "es": "Finalizar llamada"},
